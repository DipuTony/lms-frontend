            ...
            <footer className="p-4 sm:p-6 bg-[#1C1D1F]" style={{'zIndex':1000}}>
                <div className="md:flex md:justify-between">
                    ...
                    <div className="flex-initial flex">
                        ...
                        <div className="flex-initial"><span  className='text-2xl hidden md:block font-semibold md:mx-3 ml-8 text-gray-300'> Emphasis Ranchi </span></div>
                    </div>
                </div>
                <hr className="my-6 border-gray-200 sm:mx-auto  lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center font-custom-lora">© 2022 <a href="https://flowbite.com/" className="hover:underline ">Emphasis Ranchi</a>. All Rights Reserved.
                    </span>
