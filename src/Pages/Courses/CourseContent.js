...
function CourseContent(props) {
    ...
    return (
        <>
            ...
            {/* COURSE CONTENT  */}
           <CourseContentCard contents={props?.courseDetails?.contents}/>
            ...
            <div className='w-full bg-white grid grid-cols-12 px-2 sm:px-10 py-2 sm:py-10'>
                ...
                <div className="col-span-12 sm:col-span-6 px-4 py-2">
                    <h1 className='text-2xl font-bold text-gray-800 font-custom-montserrat'>Requirements</h1>

                    <ul class="space-y-1 max-w-md text-sm list-disc list-inside text-gray-700 mt-2">
                        {props?.courseDetails?.requirements?.map((data) => (
                            <li>{data}</li>
                        ))
                        }
