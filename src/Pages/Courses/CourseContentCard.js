                            ...
                            <>
                                ...
                                <div className=" grid-cols-12 p-4 transition-all" style={{ 'display': 'none' }} id={`content${index}`}>
                                    {data?.contentList?.map((content) => (
                                        <>
                                            <div className="col-span-6 text-sm ml-2"><NavLink to="/"><div className=' h-3 w-3 rounded-full inline-flex justify-center items-center bg-black mr-4'><BsFillPlayFill className='inline text-xs text-white' /></div>{content?.contentHeading}</NavLink></div>
