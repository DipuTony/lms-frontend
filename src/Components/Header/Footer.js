...
function Footer() {
    return (
        <>
            <footer class="text-gray-200 body-font bg-white border-b border-t-gray-700 border-black shadow-2xl shadow-gray-500">
                <div class="container px-5 py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    ...
                    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3 capitalize">{MenuLinks?.FooterLinks?.Footer1?.Name}</h2>
                            <nav class="list-none mb-10">
                                {
                                    MenuLinks?.FooterLinks?.Footer1?.menuitem?.map((item) => (
                                        <li>
                                            <sapn class="text-gray-600 hover:text-gray-800 hover:text-blue-600">
